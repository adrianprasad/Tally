...
#    May 19, 2022 02:55:48 PM IST  platform: Windows NT
...
import journal_support

def popup1(event, *args, **kwargs):
        Popupmenu1 = tk.Menu(journal_support.root, tearoff=0)
...
def popup2(event, *args, **kwargs):
        Popupmenu2 = tk.Menu(journal_support.root, tearoff=0)
...
def popup3(event, *args, **kwargs):
        Popupmenu3 = tk.Menu(journal_support.root, tearoff=0)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button19.configure(text='''Journal Register''')
