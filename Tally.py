...
#    May 16, 2022 11:49:17 PM IST  platform: Windows NT
from tkinter import *
import sys
...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        self.Frame1 = tk.Frame(self.top)
        self.Frame1.place(relx=0.865, rely=0.089,
                          relheight=0.915, relwidth=0.132)
        self.Frame1.configure(relief='groove')
        self.Frame1.configure(borderwidth="2")
        self.Frame1.configure(relief="groove")
        self.Frame1.configure(background="#66ddf2")
        ...
        self.Button9 = tk.Button(self.Frame1)
        self.Button9.place(relx=0.0, rely=0.065, height=24, width=257)
        self.Button9.configure(activebackground="beige")
        self.Button9.configure(activeforeground="#000000")
        ...
        self.Frame2 = tk.Frame(self.top)
        self.Frame2.place(relx=0.0, rely=0.119,
                          relheight=0.896, relwidth=0.419)
        self.Frame2.configure(relief='groove')
        self.Frame2.configure(borderwidth="2")
        self.Frame2.configure(relief="groove")
        self.Frame2.configure(background="#ffffff")
