...
#    May 19, 2022 02:55:09 PM IST  platform: Windows NT
...
import credit_support

def popup1(event, *args, **kwargs):
        Popupmenu1 = tk.Menu(credit_support.root, tearoff=0)
...
def popup2(event, *args, **kwargs):
        Popupmenu2 = tk.Menu(credit_support.root, tearoff=0)
...
def popup3(event, *args, **kwargs):
        Popupmenu3 = tk.Menu(credit_support.root, tearoff=0)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button19.place(relx=0.024, rely=0.286, height=14, width=117)
        ...
        self.Button19.configure(text='''Credit Note Register''')
