...
#    May 19, 2022 02:55:33 PM IST  platform: Windows NT
...
import debit_support

def popup1(event, *args, **kwargs):
        Popupmenu1 = tk.Menu(debit_support.root, tearoff=0)
...
def popup2(event, *args, **kwargs):
        Popupmenu2 = tk.Menu(debit_support.root, tearoff=0)
...
def popup3(event, *args, **kwargs):
        Popupmenu3 = tk.Menu(debit_support.root, tearoff=0)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button19.configure(text='''Debit Note Register''')
