...
import reciept_support

def popup1(event, *args, **kwargs):
        Popupmenu1 = tk.Menu(reciept_support.root, tearoff=0)
...
def popup2(event, *args, **kwargs):
        Popupmenu2 = tk.Menu(reciept_support.root, tearoff=0)
...
def popup3(event, *args, **kwargs):
        Popupmenu3 = tk.Menu(reciept_support.root, tearoff=0)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button19.configure(text='''Reciept Register''')
